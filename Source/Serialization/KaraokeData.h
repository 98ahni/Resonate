...
namespace Serialization 
{
    ...
    public:
        ...
        void PopColor();
        void SetGradient(uint aStartColor);
        void SetGradient(uint aStartColor, uint anEndColor);
        void PopGradient();
    ...
    private:
        ...
        bool myHasBaseEndColor = false;
        uint myBaseEndColor = 0x30FFCCE9;
        bool myHasOverrideStartColor = false;
        uint myOverrideStartColor = 0x0038F97C;
        bool myHasOverrideEndColor = false;
        uint myOverrideEndColor = 0x30FFCCE9;
        bool myHasBaseStartGradient = false;
        uint myBaseStartGradient = 0x0038F97C;
        bool myHasBaseEndGradient = false;
        uint myBaseEndGradient = 0x30FFCCE9;
        bool myHasOverrideStartGradient = false;
        uint myOverrideStartGradient = 0x0038F97C;
        bool myHasOverrideEndGradient = false;
        uint myOverrideEndGradient = 0x30FFCCE9;
